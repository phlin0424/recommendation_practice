...
from pipelines.NMF.model import NMFRecommender
...
def preprocess(pipeline_settings: PipelineSettings) -> NMFRecommender:
...
def evaluate_model(recommender: NMFRecommender) -> Metrics:
    recommender.predict()

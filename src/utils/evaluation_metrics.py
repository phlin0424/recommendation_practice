...
def cal_rmse(true_rating: list[float], pred_rating: list[float]) -> float:
...
if __name__ == "__main__":
    ...
    print(cal_rmse(true_ratings, pred_ratings))
    true_items = [1, 3, 5, 6, 10, 11]
    pred_items = [3, 5, 6, 13, 11, 12]
    print(_precision_at_k(true_items, pred_items, 5))
    print(_recall_at_k(true_items, pred_items, 5))
    ...
    print(calc_precision_at_k(true_user2items, pred_user2items, 5))
    print(calc_recall_at_k(true_user2items, pred_user2items, 5))
